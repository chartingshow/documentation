# Comprehensive Crypto Wallets List
...
| ------------------------- | --------------- | --------------------------------- | ------------------------------------------------- | --------------- | ---------------- |
| Arculus                   | Hardware (Cold) | Multi                             | NFC card-based signing                            | Non-custodial   | getarculus.com   |
| Ballet                    | Hardware        | Multi-currency                    | Hardware wallet with QR scan keys, payment card   | Non-custodial   | balletcrypto.com |
| BC Vault                  | Hardware        | Multi-currency                    | Hardware security, encrypted backup               | Non-custodial   | bc-vault.com     |
| BitAddress Paper Wallet   | Hardware        | BTC                               | Offline Paper Wallet                              | Non-custodial   | bitaddress.org   |
| BitBox                    | Hardware        | Bitcoin & altcoins                | Swiss hardware wallet, private keys               | Non-custodial   | shiftcrypto.ch   |
| BitFi                     | Hardware        | Multi-currency                    | Self-custody, air-gapped hardware wallet          | Non-custodial   | bitfi.com        |
| BITHD                     | Hardware        | Multi-currency                    | Hardware wallet, self-custody                     | Non-custodial   | bithd.com        |
| Bitlox                    | Hardware        | Multi-currency                    | Hardware wallet, Bluetooth support                | Non-custodial   | bitlox.io        |
| BitVault                  | Hardware        | Multi-currency                    | Secure hardware wallet                            | Non-custodial   | bitvault.global  |
| Burner                    | Hardware (Cold) | Limited                           | Low-cost disposable gifting wallet                | Non-custodial   | burner.pro       |
| Coldcard                  | Hardware (Cold) | Bitcoin only                      | Air-gapped, multisig, microSD backup              | Non-custodial   | coldcard.com     |
| CoolWallet                | Hardware        | BTC, ETH, LTC, Multi-currency     | Mobile/credit card-style wallet, Bluetooth, 2FA   | Non-custodial   | coolwallet.io    |
| Cypherock X1              | Hardware (Cold) | 9,000+                            | Split-key multisig                                | Non-custodial   | cypherock.com    |
| D'Cent Wallet             | Hardware        | Multi-currency                    | Biometric hardware wallet                         | Non-custodial   | dcentwallet.com  |
| Ellipal Titan             | Hardware (Cold) | Multi                             | Air-gapped mobile companion app                   | Non-custodial   | ellipal.com      |
| HW1 Ledger Wallet         | Hardware        | BTC                               | Multi-Signature                                   | Non-custodial   | ledger.com       |
| JuBiter Blade             | Hardware        | BTC, ETH, LTC                     | Portable hardware wallet                          | Non-custodial   | jubiter.com      |
| KeepKey                   | Hardware        | Multi-currency                    | HD Wallet, USB support, large screen              | Non-custodial   | keepkey.com      |
| Lattice1                  | Hardware        | Multi-currency                    | Secure hardware wallet, large touchscreen         | Non-custodial   | gridplus.io      |
| Ledger Nano S             | Hardware        | BTC, ETH, LTC, BCH, many altcoins | Secure hardware wallet, private keys, secure chip | Non-custodial   | ledger.com       |
| Ledger Nano S Plus        | Hardware (Cold) | 5,500+                            | Compact, budget-friendly, secure chip             | Non-custodial   | ledger.com       |
| Ledger Nano X             | Hardware (Cold) | 5,500+                            | Bluetooth, secure element, mobile support         | Non-custodial   | ledger.com       |
| Ledger Stax               | Hardware (Cold) | 5,500+                            | E-ink touchscreen, NFTs                           | Non-custodial   | ledger.com       |
| NGRAVE Zero               | Hardware (Cold) | 3,500+                            | Fully offline biometric security                  | Non-custodial   | ngrave.io        |
| OneKey Wallet             | Hardware        | Multi-currency                    | Non-custodial, mobile app integration             | Non-custodial   | onekey.so        |
| OpenDime                  | Hardware        | Bitcoin only                      | Air-gapped, USB stick wallet                      | Non-custodial   | opendime.com     |
| OraSaifu Wallet           | Hardware        | Multi-currency                    | Non-custodial, secure hardware wallet             | Non-custodial   | orasaifu.com     |
| Prokey Optimum            | Hardware        | Multi-currency                    | Non-custodial, secure hardware wallet             | Non-custodial   | prokeywallet.com |
| SafePal S1                | Hardware (Cold) | Multi                             | Air-gapped QR signing                             | Non-custodial   | safepal.com      |
| SafePal Wallet            | Hardware        | Multi-currency                    | Non-custodial, secure hardware wallet             | Non-custodial   | safepal.io       |
| Secalot Wallet            | Hardware        | Multi-currency                    | Non-custodial, secure hardware wallet             | Non-custodial   | secalot.com      |
...
| AMON                      | Software                    | Multi-currency                                | Fiat gateway, swaps, non-custodial                                 | Non-custodial   | amon.tech                 |
...
| BitConnect Client         | Software                    | BCC                                           | 2FA, Open Source                                                   | Non-custodial   | bitconnect.com            |
...
| BRD                       | Software                    | BTC, ETH, USDT                                | Secure, easy-to-use, multi-asset wallet                            | Non-custodial   | brd.com                   |
...
| Coin.Space                | Software                    | Bitcoin & altcoins                            | Non-custodial, simple UI                                           | Non-custodial   | coin.space                |
...
| Crypto.com DeFi           | Software                    | Multi-currency                                | Non-custodial, swaps, fiat gateway                                 | Non-custodial   | crypto.com                |
...
| Dogecoin Wallet           | Software                    | Dogecoin only                                 | Non-custodial, mobile wallet                                       | Non-custodial   | dogecoin.com              |
...
| Fordefi                   | MPC Wallet                  | Multi                                         | Institutional MPC wallet                                           | Non-custodial   | fordefi.com               |
...
| iBTC Wallet               | Software                    | Bitcoin only                                  | Non-custodial, secure Bitcoin storage                              | Non-custodial   | ibtcwallet.com            |
...
| KryptoGO Wallet           | Software                    | Multi-currency                                | Custodial, fiat gateway, compliance focus                          | Custodial       | kryptogo.com              |
...
| Manta Wallet              | Software                    | Manta Network                                 | Privacy-focused, non-custodial                                     | Non-custodial   | manta.network             |
...
| Multis                    | Multisig Wallet             | Multi                                         | 2+ key approval                                                    | Non-custodial   | multis.co                 |
...
| OctoBit.IO                | Software                    | Multi-currency                                | Custodial, swaps and fiat gateway                                  | Custodial       | octobit.io                |
...
| PumaPay Wallet            | Software                    | Multi-currency                                | Non-custodial, payment-focused                                     | Non-custodial   | pumapay.com               |
...
| Stackup                   | Smart Contract Wallet Infra | Multi                                         | Crypto asset management infra                                      | Non-custodial   | stackup.sh                |
...
| Ultimate                  | Mobile                      | Multi                                         | DeFi trading wallet                                                | Non-custodial   | ultimate.money            |
...
| Xapo Wallet               | Software                    | Multi-currency                                | Non-custodial, card integration, secure storage                    | Non-custodial   | xapo.com                  |
...
| Wallet                | Type    | Currencies Supported         | Key Features                                | Custodial Model | URL (domain)         |
| --------------------- | ------- | ---------------------------- | ------------------------------------------- | --------------- | -------------------- |
| Amon Wallet           | Custody | BTC, ETH                     | Multi-platform wallet with third-party keys | Custodial       | amonwallet.com       |
| atato Custody         | Custody | Multi-currency               | Enterprise custody, regulated in Singapore  | Custodial       | atato.com            |
| BitGo Wallet          | Custody | BTC, ETH                     | Multi-signature enterprise wallet           | Custodial       | bitgo.com            |
| Bitpanda Custody      | Custody | Multi-currency               | Institutional custody, swaps                | Custodial       | custody.bitpanda.com |
| Block.io Wallet       | Custody | BTC, LTC, DOGE               | Web wallet with encrypted keys              | Custodial       | block.io             |
| Change Wallet         | Custody | BTC, ETH                     | Mobile wallet with third-party custody      | Custodial       | changenow.io         |
| Cobo Custody          | Custody | Multi-currency               | Institutional custody, fiat gateway         | Custodial       | cobo.com             |
| CoinPayments          | Custody | BTC, ETH, LTC, many altcoins | Payment processor                           | Custodial       | coinpayments.net     |
| CryptX Wallet         | Custody | BTC, ETH                     | Exchange custody wallet                     | Custodial       | cryptx.com           |
| Custody Digital Group | Custody | Multi-currency               | Institutional custody                       | Custodial       | custodydigital.com   |
| DTCC Digital Custody  | Custody | Multi-currency               | Institutional custody solution              | Custodial       | dtcc.com             |
| Electrum LTC Wallet   | Custody | LTC                          | Web wallet, encrypted keys                  | Custodial       | electrum-ltc.org     |
| FalconX Custody       | Custody | Multi-currency               | Institutional-grade custody, fiat gateway   | Custodial       | falconx.io           |
| Fireblocks Custody    | Custody | Multi-currency               | Enterprise-grade digital asset custody      | Custodial       | fireblocks.com       |
| Holy Transaction      | Custody | BTC, ETH, LTC                | Web wallet with encrypted keys              | Custodial       | holytransaction.com  |
| Huobi Custody         | Custody | Multi-currency               | Institutional custody, fiat gateway         | Custodial       | huobicustody.com     |
| iTrust Capital        | Custody | Multi-currency               | Crypto IRA custody, institutional           | Custodial       | itrustcapital.com    |
| Jaxx Liberty Wallet   | Custody | Multiple cryptocurrencies    | Multi-platform wallet, third-party keys     | Custodial       | jaxx.io              |
| Leumi Digital Custody | Custody | Multi-currency               | Institutional custody, fiat gateway         | Custodial       | bankleumi.co.il      |
| LiteVault             | Custody | BTC                          | Web wallet                                  | Custodial       | litevault.io         |
| Lobstr                | Custody | XLM                          | Mobile wallet with third-party keys         | Custodial       | lobstr.co            |
| Matrixport Custody    | Custody | Multi-currency               | Institutional custody, fiat support         | Custodial       | matrixport.com       |
| MyMonero Wallet       | Custody | XMR                          | Web wallet, encrypted keys                  | Custodial       | mymonero.com         |
| Onchain Custodian     | Custody | Multi-currency               | Institutional custody, Singapore-based      | Custodial       | onchaincustodian.com |
| Rivo.xyz              | Custody | Multi-currency               | Custodial, Singapore-based                  | Custodial       | rivo.xyz             |
| RuufPay Wallet        | Custody | Multi-currency               | Custodial, DeFi & staking support           | Custodial       | ruufpay.com          |
| SpectroCoin           | Custody | BTC, ETH, LTC, EUR, USD      | Exchange and multi-currency wallet          | Custodial       | spectrocoin.com      |
| UberPay Wallet        | Custody | BTC, ETH                     | Mobile wallet with encrypted keys           | Custodial       | uberpay.io           |
| Xapo                  | Custody | BTC                          | Bitcoin wallet & vault with cold storage    | Custodial       | xapo.com             |
